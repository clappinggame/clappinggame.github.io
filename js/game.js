...
function pc()//电脑自动
{
    if(aq==0)//我方0气
    {
        ...
        else
        {
            ...
            else if(r==5) return 521;
            else if(r==6) return 522;
        }
    }
    if(aq==1)//我方1气
    {
    ...
    else if(aq>=2)//我方>=2气
    {
        ...
        if(bq==0)
        {
            r=rnd(1,5);
            if(r<3)return 000;
            else if(r==3) return 100;
            else if(r==4) return 250;
            else return mov();
        }
        else if(bq==1)
        {
...
function ok()
{
    ...
    switch(bb)
    {
        ...
        case 250:document.getElementById("bb").innerHTML = "神反";break;
	...
	//color
    if (aa==000)document.getElementById("aa").innerHTML = "气";
	if (c(aa)>aq)
	aa=000;
	colorit(aa);
    ...
    if(dead==0){document.getElementById("timer").innerHTML = "平局";
				if(x2==1)
					{
						x=4;setTimeout("countsecond2()", 1000);return;
					}
				else if(x2==0)
					{
						x=10;setTimeout("countsecond2()", 350);return;
					}
				return;
            }
...
{　
	if(document.getElementById("mansu").checked==true)
		{
			x=4;x2=1;
		}
	else if(document.getElementById("mansu").checked==false)
		{
			x=10;x2=0;
		}
	countsecond2();
...
function countsecond2()
{
	...
	if(x2==1)
	{
		if(x>1)
		{ 
			x = x-1;document.getElementById("timer").innerHTML=x;
			setTimeout("countsecond2()", 1000);
		}	
		else 
	{
		ok();
	...
	else if(x2==0)
	{
		if(x>1)
			{
				x = x-1;document.getElementById("timer").innerHTML="0."+x;
		setTimeout("countsecond2()", 90);
			}
		else 
	{
		ok();
